            ...
            <body onload="return checkNumberOfCar()">
                            ...
                            <li>
                                <select name="txtCate">
                                    ...
                                    <c:forEach var="cate" items="${sessionScope.CATECAR}">
                                        <option label="${cate.categoryName}" value="${cate.categoryID}" <c:if
                                            test="${cate.categoryID eq param.txtCate}">
                                            selected="selected"
                                            </c:if> />
                                    </c:forEach>
                                </select>
                ...
                <div>
                    ...
                    <c:if test="${not empty cart}">
                        <form action="CartDispatch" onsubmit="return check()" method="POST">
                            <!--Cart-->
                                        ...
                                        <c:forEach var="entry" items="${cart.items}" varStatus="counter">
                                            <c:if test="${entry.key eq dto.carID}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span onclick="return increase('${dto.carID}')">+</span>
                                                        <span id="amount${dto.carID}">${entry.value}</span>
                                                        <span onclick="return decrease('${dto.carID}')">-</span>
                            ...
                            <c:if test="${not empty sessionScope.CUSCART}">
                                <div id="GuestTable">
                                    ...
                                    <div>
                                        <input id="Confirm" type="submit" value="Confirm" name="btAction" />
                                    </div>
                                </div>
                            </c:if>
                        </form>
