...
public class DetailsCarServlet extends HttpServlet {
    ...
    private final String detailsPage = "details";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String carID = request.getParameter("pk");
        ServletContext context = request.getServletContext();
        Map<String, String> map = (Map<String, String>) context.getAttribute("MAP");
        String url = map.get(detailsPage);
        try {
            TblCarDAO carDAO = new TblCarDAO();
            carDAO.loadDetailsCar(carID);
            List<TblCarDTO> list = carDAO.getListCar();
            request.setAttribute("DETAILSCAR", list);
        } catch (SQLException ex) {
            Logger.getLogger(DetailsCarServlet.class.getName()).log(Level.SEVERE, null, ex);
